...
namespace CourseManagement.Tests
{
    ...
    {
        [Fact]
        public void CourseBuilder_ShouldBuildOnlineCourseCorrectly()
        {
            // Arrange & Act
        ...
        [Fact]
        public void CourseBuilder_ShouldBuildOfflineCourseCorrectly()
        {
            // Arrange & Act
            var course = new CourseBuilder()
                .SetId(1)
                ...
                .SetTeacherId(1)
                .SetMaxStudents(25)
                .SetType(CourseType.Offline)
                .SetRoom("A101")
                .SetSchedule("Mon 10:00-11:30")
                .Build();
        ...
        [Fact]
        public void CourseBuilder_ShouldThrowExceptionForInvalidCourseType()
        {
            // Arrange & Act & Assert
            Assert.Throws<ArgumentException>(() => new CourseBuilder()
                .SetId(1)
                .SetName("Test Course")
                .SetDescription("Test Description")
                .SetTeacherId(1)
                .SetMaxStudents(30)
                .SetType((CourseType)999) // Invalid enum value
                .Build());
        }
    }

    public class CourseManagementSystemSingletonTests
    {
        [Fact]
        public void Instance_ShouldReturnSameInstance()
        {
            // Act
            var instance1 = CourseManagementSystem.Instance;
            var instance2 = CourseManagementSystem.Instance;
        ...
        [Fact]
        public void Instance_ShouldHaveCourseManager()
        {
            // Act
            var system = CourseManagementSystem.Instance;

            // Assert
            Assert.NotNull(system.CourseManager);
        }

        [Fact]
        public void Instance_ShouldHaveCourseFactory()
        {
            // Act
            var system = CourseManagementSystem.Instance;

            // Assert
            Assert.NotNull(system.CourseFactory);
        }
        ...
        public void Reset_ShouldCreateNewInstance()
        {
            // Arrange
            var instance1 = CourseManagementSystem.Instance;
            CourseManagementSystem.Instance.Reset();
    ...
    {
        [Fact]
        public void CreateOnlineCourse_ShouldCreateCorrectOnlineCourse()
        {
            // Arrange
            var factory = new CourseFactory();

            // Act
            var course = factory.CreateOnlineCourse(1, "Test Course", "Test Description", 1, 30, "Zoom");
        ...
        [Fact]
        public void CreateOfflineCourse_ShouldCreateCorrectOfflineCourse()
        {
            // Arrange
            var factory = new CourseFactory();

            // Act
            var course = factory.CreateOfflineCourse(1, "Test Course", "Test Description", 1, 25, "A101", "Mon 10:00-11:30");
